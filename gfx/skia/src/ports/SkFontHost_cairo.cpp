...
public:
    ...
    {
        SkDebugf("SkCairoFTTypeface::onGetAdvancedTypefaceMetrics unimplemented");
        return NULL;
    }
    ...
    {
        SkDebugf("SkCairoFTTypeface::onFilterRec unimplemented");
    }

    virtual void onGetFontDescriptor(SkFontDescriptor*, bool*) const SK_OVERRIDE
    {
        SkDebugf("SkCairoFTTypeface::onGetFontDescriptor unimplemented");
    }
...
{
    SkDebugf("SkScalerContext_CairoFT::generateFontMetrics unimplemented\n");
}
